...
import { ArrowLeft, BookOpen, Globe, Users, Edit3, BarChart2, Wand2, Plus, Save, Layers, UserPlus, StopCircle, Trash2, Library, Sparkles, Feather, Compass, GitMerge, FileText, Activity, Link, Star } from 'lucide-vue-next';
                ...
                <div class="chapter-item-header">
                  ...
                  <div style="display: flex; align-items: center; gap: 6px;">
                    <span v-if="ch.status === 'completed' && getChapterReviewScore(ch.reviewFeedback)" 
                          :style="{ fontSize: '10px', fontWeight: 'bold', color: '#fff', background: getReviewScoreColor(getChapterReviewScore(ch.reviewFeedback)), padding: '2px 5px', borderRadius: '4px' }"
